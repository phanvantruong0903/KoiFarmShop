        ...
        <Content style={{ padding: "50px" }}>
          ...
          >
            ...
            <Paragraph style={{ color: "#333", marginBottom: "15px" }}>
              ...
              <ul>
                <li>Ký gửi cá Koi offline: Cung cấp thông tin Koi cần ký gửi bằng hình ảnh, video, giấy chứng nhận…</li>
            ...
            <Paragraph style={{ color: "#333", marginBottom: "15px" }}>
              ...
              <ul>
                ...
                <li>Koi phải có giấy chứng nhận, ưu tiên các Koi thuần chủng.</li>
            ...
            <Paragraph style={{ color: "#333", marginBottom: "15px" }}>
              ...
              <ul>
                <li><strong>Phổ biến tại Nhật Bản:</strong> Dịch vụ rất phổ biến tại Nhật Bản.</li>
                <li><strong>Bắt đầu nở rộ tại Việt Nam:</strong> Người chơi Koi tìm đến các dịch vụ ký gửi.</li>
              </ul>
            </Paragraph>
            ...
            >
              {isExpanded && (
                <>
                  <Paragraph style={{ color: "#333", marginBottom: "15px" }}>
                    OnKoi – Quang Minh là trang trại cá Koi với hệ thống hồ nuôi chuyên nghiệp...
                  </Paragraph>
                  <Paragraph style={{ color: "#333", marginBottom: "15px" }}>
                    <h5 style={{ color: "#e74c3c", marginTop: "20px" }}>Chúng tôi cam kết:</h5>
                    <ul>
                      <li>100% giống F0 và F1 có nguồn gốc từ những trại nổi tiếng.</li>
                  ...
                  <Paragraph style={{ color: "#333", marginBottom: "15px" }}>
                    <h5 style={{ color: "#e74c3c", marginTop: "20px" }}>Lưu ý: Đối với Koi baby</h5>
                    <ul>
                  ...
                  <Paragraph style={{ color: "#333", marginBottom: "15px" }}>
                    <h5 style={{ color: "#e74c3c", marginTop: "20px" }}>Về bảo hành Koi:</h5>
                    <ul>
